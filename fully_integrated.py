...
def wtg_foundation(steel_den=7850, steel_poisson=0.3, steel_YM=200e+9, steel_damping=0.01, # material parameters
    ...
    def soil_model(soil_k_vec):

        # priors information?

        # Initialise natural frequency array
        pop_size = len(soil_k_vec) # variable naming needs reviewing here
    ...
    Y = np.genfromtxt(r'C:\Users\mes22ss\Ansys\PythonScripts\foundation_modelling\GeneratedY.csv', delimiter=',')
    ...
    with pm.Model() as hierarchical_model:
        ...
        obs = pm.Normal('obs', soil_model(soil_k_vec=LEk), LVk, observed=Y) # this line might need [turbines] like linear regression example to get same dims as Y
        # TODO can't pass tensors to soil_model function
